...
# Save 3D model as obj and glb file
save_model("inst/","buildings", coords)

# Save 3D model as glb file with a specific color
...
# Rotate VR model clockwise with default speed
rotate_VR("output.html", TRUE)

# Rotate VR model clockwise/counterclockwise with a specific speed
#rotate_VR("output.html", TRUE, speed = 0.0002, clockwise = 0)

# Stop the VR model rotation
